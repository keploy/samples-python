...
def deeply_nested_payload(endpoint_name, endpoint_idx):
    ...
    # ---------- MODIFICATION START ----------
    # This block introduces a deterministic change for specific endpoints.
    if endpoint_idx in [1, 3]:
        # Let's make a slight, persistent change to the Stripe live key.
        # We'll append a fixed suffix.
        commons["stripe_live_key"] = commons["stripe_live_key"] + "_MODIFIED"
    # ---------- MODIFICATION END ----------
